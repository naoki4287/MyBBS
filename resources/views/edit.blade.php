<x-app-layout>
  <div>
    ...
    <form action="/delete" method="POST" class="float-right">
      ...
      <button type="submit" id="deleteBtn" class=" mr-12 p-2 text-white bg-red-400 rounded-md float-right">削除する</button>
    </form>
    ...
    <form class="text-center mt-32" action="{{ route('update') }}" method="POST">
      ...
      <div class="space-x-48">
        ...
        <button type="submit" class="w-2/12 mt-12 p-2 text-white rounded-md bg-red-700">完了する</button>
      </div>
    </form>
  </div>
